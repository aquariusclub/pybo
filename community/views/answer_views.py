...
def answer_create(request, question_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            answer.save()
            return redirect('{}#answer_{}'.format(resolve_url('community:detail', question_id=question.id), answer.id))
    else:
        form = AnswerForm()
...
def answer_modify(request, answer_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            answer.save()
            return redirect('{}#answer_{}'.format(resolve_url('community:detail', question_id=answer.question.id), answer.id))
    else:
